...
#'@param col_test test for -9999 in this column, usually the 4th column in FUSION outputs. This indicates that no points were present in this cell.
#'
#'@return
#'  NULL
#'
...
csv_to_sqlite=function(
  ...
  if(length(col_test) > 0) warning("multiple test columns 'col_test' supplied, only the first one was used")
